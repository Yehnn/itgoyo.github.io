(function(t, e) {
        var s = e.body,
            ...
            x = {
                ...
                toggleMenu: function(e) {
                    var i = n("#main");
                    if (e) {
                        if (c.classList.remove("hide"), t.innerWidth < 1241)
                            if (d.classList.add("in"), c.classList.add("show"), p) {
                                var s = $.scrollTop;
                                i.classList.add("lock"), i.scrollTop = s
                            } else o.classList.add("lock")
                    } else if (c.classList.remove("show"), d.classList.remove("in"), p) {
                        var s = i.scrollTop;
                        i.classList.remove("lock"), $.scrollTop = s
                ...
                modal: function(t) {
                    ...
                    }, x.hideOnMask.push(this.hide), this.$off && this.$off.addEventListener(L, this.hide)
                },
                share: function() {
                    var t = n("#pageShare"),
                        i = n("#shareFab"),
                        s = new this.modal("#globalShare");
                    n("#menuShare").addEventListener(L, s.toggle), i && (i.addEventListener(L, function() {
                        t.classList.toggle("in")
                    }, !1), e.addEventListener(L, function(e) {
                ...
                reward: function() {
                    var t = new this.modal("#reward");
                    var t = new this.modal("#reward");
                    n("#rewardBtn").addEventListener(L, t.toggle) + a("#rewardBtn").addEventListener(L, t.toggle);
            ...
            waterfall: function() {
                t.innerWidth < 760 || g.call(a(".waterfall"), function(t) {
                    var e = t.querySelectorAll(".waterfall-item"),
                        i = [0, 0];
                    g.call(e, function(t) {
                        var e = i[0] <= i[1] ? 0 : 1;
                        t.style.cssText = "top:" + i[e] + "px;left:" + (e > 0 ? "50%" : 0), i[e] += t.offsetHeight
                    }), t.style.height = Math.max(i[0], i[1]) + "px", t.classList.add("in")
                })
            },
            tabBar: function(t) {
            ...
            lightbox: function() {
                function i(i) {
                    this.$img = i.querySelector("img"), this.$overlay = i.querySelector("overlay"), this.margin = 40, this.title = this.$img.title || this.$img.alt || "", this.isZoom = !1;
                    var n, a, o, l, c;
                    this.calcRect = function() {
                        l = s.clientWidth, c = s.clientHeight;
                    ...
                    this.zoomIn = function() {
                        n = this.$img.naturalWidth || this.$img.width, a = this.$img.naturalHeight || this.$img.height, o = this.$img.getBoundingClientRect(), i.style.height = o.height + "px", i.classList.add("ready"), this.setFrom(), this.addTitle(), this.$img.classList.add("zoom-in"), setTimeout(function() {
                            i.classList.add("active"), r.setTo(), r.isZoom = !0
                        }, 0)
                    }, this.zoomOut = function() {
                        this.isZoom = !1, i.classList.remove("active"), this.$img.classList.add("zoom-in"), this.setFrom(), setTimeout(function() {
                            r.$img.classList.remove("zoom-in"), r.$img.style.cssText = "", r.removeTitle(), i.classList.remove("ready"), i.removeAttribute("style")
                        }, 300)
        ...
        u.classList.remove("active"), x.page.loaded(), t.lazyScripts && t.lazyScripts.length && x.loadScript(t.lazyScripts)
    }), t.addEventListener("DOMContentLoaded", function() {
        x.waterfall();
        var t = $.scrollTop;
        x.toc.fixed(t), x.toc.actived(t), x.page.loaded()
    });
    var E = !1; n('a[href^="mailto"]').addEventListener(L, function() {
        E = !0
    }), t.addEventListener("beforeunload", function(t) {
        E ? E = !1 : x.page.unload()
    }), t.addEventListener("pageshow", function() {
        !x.page.visible && x.page.loaded()
    }), t.addEventListener("resize", function() {
        t.BLOG.even = L = "ontouchstart" in t ? "touchstart" : "click", x.toggleMenu(), x.waterfall()
    }), l.addEventListener(L, function() {
        v(x.goTop.bind(x, 0))
    }, !1), h.addEventListener(L, function(t) {
        x.toggleMenu(!0), t.preventDefault()
    }, !1), f.addEventListener(L, function() {
        c.classList.add("hide")
    }, !1), d.addEventListener(L, function(t) {
        x.toggleMenu(), x.hideOnMask.forEach(function(t) {
            t()
        }), t.preventDefault()
    }, !1), e.addEventListener("scroll", function() {
        var t = $.scrollTop;
        x.toggleGotop(t), x.fixedHeader(t), x.toc.fixed(t), x.toc.actived(t)
    }, !1), t.BLOG.SHARE && x.share(), t.BLOG.REWARD && x.reward(), x.noop = y, x.even = L, x.$ = n, x.$$ = a, Object.keys(x).reduce(function(t, e) {
        return t[e] = x[e], t
    }, t.BLOG), t.Waves ? (Waves.init(), Waves.attach(".global-share li", ["waves-block"]), Waves.attach(".article-tag-list-link, #page-nav a, #page-nav span", ["waves-button"])) : console.error("Waves loading failed.")
})(window, document);
